...
%Perform the transformation by using the applycform function it's mean to converts 
% the color values in  Image (Im) to the color space specified in the color 

...
fc ='pool10'; %'efficientnet-b0|model|head|dense|MatMul' %% resnet101's layer name from which perform the feature extraction

% Training set extraction
featuresresnet101 = activations(squeezenet, audsTV, fc, 'MiniBatchSize', 32);
featuresresnet101 = squeeze(featuresresnet101);
featuresresnet101 = featuresresnet101';

% Test set extraction
featuresresnet101Test = activations(squeezenet, audsTest, fc, 'MiniBatchSize', 32);
featuresresnet101Test = squeeze(featuresresnet101Test);
featuresresnet101Test = featuresresnet101Test';
...
cvp = cvpartition(labelC,'holdout',155)

	Xtrain = FeatureCombin(cvp.training,:);
	ytrain = label(cvp.training,:);
	Xtest  = FeatureCombin(cvp.test,:);
	ytest  = label(cvp.test,:);
...
fc ='efficientnet-b0|model|head|dense|MatMul'; %'efficientnet-b0|model|head|dense|MatMul' %% resnet101's layer name from which perform the feature extraction

% Training set extraction
featuresresnet101 = activations(efficientnetb0, audsTV, fc, 'MiniBatchSize', 32);
featuresresnet101 = squeeze(featuresresnet101);
featuresresnet101 = featuresresnet101';

% Test set extraction
featuresresnet101Test = activations(efficientnetb0, audsTest, fc, 'MiniBatchSize', 32);
featuresresnet101Test = squeeze(featuresresnet101Test);
featuresresnet101Test = featuresresnet101Test';
